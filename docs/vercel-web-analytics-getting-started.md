...
> **Note:** This step is required for: Next.js (pages), Next.js (app), Remix, Create React App, Nuxt, Vue, and Astro frameworks. For SvelteKit, plain HTML, and other frameworks, specific implementations apply.
